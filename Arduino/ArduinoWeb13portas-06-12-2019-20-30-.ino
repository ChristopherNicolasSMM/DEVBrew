...
IPAddress ip(192, 168, 137, 12);                       // Definição do endereço IP que a Ethernet Shield terá na rede onde estiver conectada. Verifique a Máscara-de-subrede e todos os equipamentos conectados na rede para achar um IP compatível e livre.
...
const byte qtdePinosDigitais = 10;
byte pinosDigitais[qtdePinosDigitais] = {2, 3, 5, 6, 7, 8, 9, A3, A4, A5};
byte modoPinos[qtdePinosDigitais]     = {OUTPUT, OUTPUT, OUTPUT, OUTPUT, OUTPUT, OUTPUT, OUTPUT, OUTPUT, OUTPUT, OUTPUT};

const byte qtdePinosAnalogicos = 3;
byte pinosAnalogicos[qtdePinosAnalogicos] = {A0, A1, A2};
